<?php
/* Smarty version 3.1.34-dev-7, created on 2020-08-30 17:34:12
  from 'D:\software\wampserver\www\server\mvc\application\template\admin\login.html' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.34-dev-7',
  'unifunc' => 'content_5f4be314c3dd03_12780454',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '15e9cf5533f928d8f86995a7a5284ac6a250ac88' => 
    array (
      0 => 'D:\\software\\wampserver\\www\\server\\mvc\\application\\template\\admin\\login.html',
      1 => 1598808831,
      2 => 'file',
    ),
  ),
...
function content_5f4be314c3dd03_12780454 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<form style="height: 360px" class="form-horizontal" action="admin/index/login" method="post">
    ...
    <div class="form-group">
        ...
        <input style="width:35%"   type="text" placeholder="请输入验证码" name="code" id="code">
            <img src="http://localhost/server/mvc/index.php/admin/index/mycode" alt="" onclick="this.src='http://localhost/server/mvc/index.php/admin/index/mycode'" style="cursor: pointer"><span style="font-size: 14px">看不清？换一张</span>
        </div>
    </div>
