...
//        $str.="<table>";
    ...
    function tree($pid=0,&$str,$i=0){
        ...
        while ($row=$result->fetch_assoc()){
          ...
          <a class="remove" href="/server/mvc/index.php/admin/category/del?cid='.$row["cid"].'" attr="'.$row["cid"].'">删除</a>
    ...
    function add(){
        ...
        if($db->affected_rows>0){
            header("location:/server/mvc/index.php/admin/category");
    ...
    function del(){
          ...
          if($result->num_rows>0){
              echo "<script>alert('请先删除子目录');location.href='/server/mvc/index.php/admin/category'</script>";
          }else{
